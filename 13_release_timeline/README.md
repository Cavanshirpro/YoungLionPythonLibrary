# 13. Release milestone timeline

## Scenario

Represent product milestones on a timeline.
...
Represent product milestones on a timeline. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
Progress at day 65: 0.65
Middle events: [{'time': 40, 'name': 'feature-freeze', 'data': None}, {'time': 80, 'name': 'rc', 'data': None}]
```
