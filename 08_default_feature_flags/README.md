# 08. Default feature flags

## Scenario

Create missing feature flags lazily with a default factory.

## Project structure

```text
08_default_feature_flags/
├── README.md
└── main.py
```
...
Create missing feature flags lazily with a default factory. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
