# 11. Temperature range validator

## Scenario

Use Range for clamping and normalization in sensor logic.

## Project structure

```text
11_temperature_range/
├── README.md
└── main.py
```
...
Use Range for clamping and normalization in sensor logic. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
