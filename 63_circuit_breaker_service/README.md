# 63. Circuit breaker around a service

## Scenario

Stop repeated calls after a dependency keeps failing.

## Project structure

```text
63_circuit_breaker_service/
├── README.md
└── main.py
```
...
Stop repeated calls after a dependency keeps failing. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
