# 12. Game velocity vector

## Scenario

Perform common 2D/3D vector operations.

## Project structure

```text
12_game_velocity_vector/
├── README.md
└── main.py
```
...
Perform common 2D/3D vector operations. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
Speed: 5.0
Direction: [0.6000000000000001, 0.8]
Halfway velocity: [6.5, 2.0]
```
