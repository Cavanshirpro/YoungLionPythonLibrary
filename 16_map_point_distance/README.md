# 16. Map point distance

## Scenario

Compute 2D distances and midpoints.

## Project structure

```text
16_map_point_distance/
├── README.md
└── main.py
```
...
Compute 2D distances and midpoints. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```python
from YoungLion import Point

a = Point(10, 20)
b = Point(25, 35)
print("Distance:", a.distance_to(b))
print("Midpoint:", a.midpoint(b).to_dict())
```
