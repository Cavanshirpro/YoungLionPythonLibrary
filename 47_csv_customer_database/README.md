# 47. Small CSV customer database

## Scenario

Write, append, read and update CSV rows.

## Project structure

```text
47_csv_customer_database/
├── README.md
└── main.py
```
...
Write, append, read and update CSV rows. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
[{'id': '1', 'name': 'Alice'}, {'id': '2', 'name': 'Robert'}, {'id': '3', 'name': 'Cavan'}]
```
