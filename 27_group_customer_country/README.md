# 27. Group customers by country

## Scenario

Create groups and counts without hand-written loops.

## Project structure

```text
27_group_customer_country/
├── README.md
└── main.py
```
...
Create groups and counts without hand-written loops. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
