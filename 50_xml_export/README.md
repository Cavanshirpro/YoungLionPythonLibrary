...
Export a nested mapping to XML and read it back.
...
Export a nested mapping to XML and read it back. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
