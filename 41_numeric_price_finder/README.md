# 41. Nearest product prices

## Scenario

Use NumericSearch for range/nearest lookups.

## Project structure

```text
41_numeric_price_finder/
├── README.md
└── main.py
```
...
Use NumericSearch for range/nearest lookups. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
30-120: [(49.0, 'keyboard'), (99.0, 'headset')]
Nearest 55: [(49.0, 'keyboard'), (19.99, 'mouse')]
```
