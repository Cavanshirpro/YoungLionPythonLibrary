# 19. Category tree navigation

## Scenario

Build and traverse a product category tree.
...
Build and traverse a product category tree. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
['Store', 'Electronics', 'Laptops', 'Phones', 'Books']
Depth: 2 Nodes: 5
```
