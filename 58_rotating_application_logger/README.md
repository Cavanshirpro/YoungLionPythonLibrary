# 58. Rotating application logger

## Scenario

Write structured contextual logs with local rotation settings.

## Project structure

```text
58_rotating_application_logger/
├── README.md
└── main.py
```
...
```bash
cd 58_rotating_application_logger
python main.py
```
...
Write structured contextual logs with local rotation settings. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
...
```text
[2026-08-10T22:08:50+00:00] [INFO] payment validated {"component":"payments","request_id":"r-17","amount":42.5}
[2026-08-10T22:11:24+00:00] [INFO] payment validated {"component":"payments","request_id":"r-17","amount":42.5}
[2026-08-10T22:15:23+00:00] [INFO] payment validated {"component":"payments","request_id":"r-17","amount":42.5}
```
