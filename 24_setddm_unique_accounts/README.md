# 24. Unique account registry

## Scenario

Use SetDDM with a primary-key path.

## Project structure

```text
24_setddm_unique_accounts/
├── README.md
└── main.py
```
...
Use SetDDM with a primary-key path. The example is intentionally small enough to read in one sitting, but the same API is designed to scale into a larger application module.
